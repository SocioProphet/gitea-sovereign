...
def validate_provider_receipt() -> dict[str, Any]:
    ...
    if receipt["operation"] != "forge.pull_request.merge":
        raise ValidationError("valid-provider-receipt: expected merge operation")
...
def main() -> int:
    ...
    print("validated provider receipt, reconciliation result, and false-completion negative fixture")
    return 0
